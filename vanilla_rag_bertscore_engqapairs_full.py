#!/usr/bin/env python3
"""
Vanilla RAG BERTscore Evaluation for ENGqapairs (Full Dataset)
=============================================================
Processes all 85 English questions
"""
...
def get_vanilla_rag_responses(questions, max_questions=None):
    ...
    try:
        ...
        print(f"❌ Error initializing Vanilla RAG system: {str(e)}")
        return []
...
def main():
    """Main function for full dataset evaluation"""
    print(" Starting Vanilla RAG BERTscore Evaluation for ENGqapairs (Full Dataset)")
    print("=" * 80)
    ...
    # Load data
    print("\n Loading ENGqapairs dataset...")
    questions = load_engqapairs()
    print(f"✅ Loaded {len(questions)} questions")
    
    # Get Vanilla RAG responses (all questions)
    ...
    results = {
        'evaluation_info': {
            ...
            'dataset': 'ENGqapairs (Full Dataset)',
    ...
    output_file = f"vanilla_rag_bertscore_engqapairs_full_{timestamp}.json"
    
    with open(output_file, 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)
    
    print(f"\n✅ Results saved to: {output_file}")
    print(f"Dataset: ENGqapairs (Full Dataset)")
