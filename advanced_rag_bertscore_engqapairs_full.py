#!/usr/bin/env python3
"""
GPU-Accelerated Advanced RAG BERTscore Evaluation for ENGqapairs (Full Dataset)
================================================================================
Uses GPU acceleration and processes all 85 English questions
"""
...
def main():
    ...
    print("🚀 Starting GPU-Accelerated Advanced RAG BERTscore Evaluation for ENGqapairs (Full Dataset)")
    print("=" * 80)
    ...
    output_file = f"advanced_rag_bertscore_engqapairs_full_{timestamp}.json"
